...
#                 add = True
#                 break
#     if(not add): unmix.append(hex(c))
# 
# print(unmix)

dyes = [
    0xf0f0f0, 0x1d80f9, 0x3dd8fe, 0x1fc780,
    0x167c5e, 0x979d9d, 0x9c9c16, 0xdab33a,
    0xaa443c, 0xb83289, 0xbd4ec7, 0xaa8bf3,
    0x524f47, 0x211d1d, 0x325483, 0x262eb0,
]
