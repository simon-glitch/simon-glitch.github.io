    ...
    0xad59: (r0, r1, r2) => {
        ...
        const rm = function(ez) {
            ...
            rH.jsxs)(ry, {
                ...
                rH.jsx)(rP, {
                    children: ez.count
                }), ez.durability && ez.durability > 0 && ez.durability < 1 ? (0,
                rH.jsx)(rQ, {
                    children: (0,
                    rH.jsx)(rX, {
                ...
                rH.jsx)(rB, {
                    'data-slot-id': undefined !== ez.slotId ? '' + ez.slotId : undefined
                })]
            });
        }
        ...
        function rC(ez, eA) {
            ...
            for (eO = 0; eO < ev.length; eO++)
                ej = ev[eO],
                eA.indexOf(ej) >= 0 || (eJ[ej] = ez[ej]);
            return eJ;
        }
        ...
        const ra = function(ez) {
            ...
            rH.jsxs)(rV, {
                ...
                children: [ev.background_icon && ev.type === r8.S.bDI && (0,
                rH.jsx)(rW, {
                    $src: ev.background_icon
                }), ev.quick_select_key && (0,
                rH.jsx)(rx, {
                    children: ev.quick_select_key
                }), (eD || ev.selected) && !eJ && (0,
                rH.jsx)(rs, {}), ev.active && (0,
                rH.jsx)(rG, {}), (0,
                rH.jsx)(rm, {
                    slotId: ev.slotId,
                    type: ev.type,
        ...
        var rI = r2(0x7c38)
          ...
          , rY = function(ez) {
            ...
            rI.LX)(0, 0))
              , R6 = R5[0]
              , R7 = R5[1]
              , R8 = (null == eu ? undefined : eu.index) === eO.slotId
              , R9 = eO.type
              , RF = eO.durability
              , RE = eO.count;
            ...
            (0,
            rH.jsxs)(rc, {
                children: [(null == eu ? undefined : eu.showCount) && eu.index === eO.slotId && (0,
                rH.jsxs)(rq, {
                    children: [(0,
                    rH.jsx)(rf, {
                        children: eu.count
                ...
                rH.jsx)(ra, {
                    active: eO.active,
                    selected: (null == eu ? undefined : eu.index) === eO.slotId,
                    type: R9,
                    tier: eO.tier,
                    count: RE,
                    durability: RF,
                    ...
                    onClick: function(Rp) {
                        rR.A && (R4.current ? R4.current = false : eb !== r9.K.bfC ? (eu && eu.index !== eO.slotId ? (r6.A.emit(r7.r.bKr, eu.index, eO.slotId, eu.count),
                        R0(undefined)) : eO.type !== r8.S.bDI && R0({
                            index: eO.slotId,
                            count: eO.count,
                            total: eO.count
                        }),
                        ...
                        ev(undefined),
                        R2(undefined)) : r6.A.emit(r7.r.buA, eO.slotId));
                    },
                    onPointerDown: function(Rp) {
                        if (eb !== r9.K.bfC) {
                            if (Rp.preventDefault(),
                            rR.A) {
                                if (eO.type === r8.S.bDI || eO.count <= 1)
                                    return;
                                ev(undefined),
                                R1(undefined),
                                R7((0,
                    ...
                    onPointerMove: function(Rp) {
                        if (eb !== r9.K.bfC && rR.A && eO.type !== r8.S.bDI && ej) {
                            if (R4.current) {
                                Rp.stopPropagation();
                                var RS = (0,
                                rg.qE)(Rp.clientX - R6.bbZ + 0x32, 0, 0x64);
                                R0({
                                    index: eO.slotId,
                                    count: Math.max(Math.ceil(RS / 0x64 * eO.count), 1),
                                    total: eO.count,
                                    showCount: true
                                });
                            } else {
                                ...
                                R2({
                                    ...
                                    bIo: eO.type,
                                    bDb: eO.count,
                                    bJv: null != (RR = eO.durability) ? RR : 0
                                });
                            }
                        }
                    },
        ...
        var rv = r3.Ay.div(['width:', 'px;height:', 'px;display:flex;justify-content:center;align-items:center;'], function(ez) {
          ...
          , rD = r3.Ay.div.attrs(function(ez) {
            var eA = ez.$left
              , ej = undefined === eA ? 0 : eA
              , eO = ez.$bottom
              , eJ = undefined === eO ? 0 : eO
              , ev = ez.$width
              , eb = ez.$height
              , eD = ez.$src
              , eu = ez.$direction;
        ...
        const ru = function(ez) {
            var eA = ez.iconPixelWidth / ez.pixelScale
              ...
              , eO = (ez.iconPixelWidth - 2 * ez.gapPixelSize) / ez.pixelScale
              , eJ = (ez.iconPixelHeight - 2 * ez.gapPixelSize) / ez.pixelScale
        ...
        const F4 = function() {
            ...
            r4.x)(function(eu) {
                return eu.bCu;
            }), ej = ez / 10, eO = [], eJ = [], ev = 0; ev < ej; ev++) {
                var eb = 10 * ev
                  , eD = 1;
                eA < eb ? eD = 0 : eA >= eb && eA < 10 * (ev + 1) && (eD = (eA - eb) / 10),
                eJ.push((0,
                rH.jsx)(F3, {
                    children: (0,
                    rH.jsx)(F0, {
                ...
                10 === eJ.length && (eO.unshift((0,
                rH.jsx)(F2, {
                    children: eJ
                }, eO.length)),
                eJ = []);
            }
            return eJ.length > 0 && eO.unshift((0,
            rH.jsx)(F2, {
                children: eJ
            }, eO.length)),
            (0,
        ...
        r5.forwardRef)(function(ez, eA) {
            var ej = ez.direction
              , eO = undefined === ej ? 'row' : ej
              , eJ = ez.paddingTop
              , ev = undefined === eJ ? 0x14 : eJ
              , eb = ez.paddingRight
              , eD = undefined === eb ? 0x14 : eb
              , eu = ez.paddingBottom
              , R0 = undefined === eu ? 0x14 : eu
              , R1 = ez.paddingLeft
              , R2 = undefined === R1 ? 0x14 : R1
              , R3 = ez.scrollable
              , R4 = undefined !== R3 && R3
              , R5 = rC(ez, F7)
              , R6 = (0,
            ...
            rH.jsxs)(F8, {
                ...
                $paddingBottom: R0,
                $paddingLeft: R2,
                children: [(R5.title || R5.titleItem) && (0,
                rH.jsxs)(F9, {
                    children: [R5.title && (0,
                    rH.jsx)(FF, {
                        children: R5.title
        ...
        var FP = r2(0xa9c3)
          ...
          , Fm = function() {
            ...
            r4.x)(function(eu) {
                return eu.bJx;
            }), ev = [], eb = 0; eb < rl.A.bsg; eb++) {
                var eD = eA[eb];
                ev.push((0,
                rH.jsx)(rz, {
                    active: eb === ez,
                    quick_select_key: (eb + 1).toString(),
                    type: eD.bIo,
                    tier: eD.bJw,
                    count: eD.bDb,
                    durability: eD.bJv,
        ...
        const FI = function(ez) {
            ...
            rH.jsx)(ra, {
                ...
                selected: (null == eb ? undefined : eb.index) === ez.slotId,
                type: ez.type,
                tier: ez.tier,
                count: ez.count,
                ...
                onPointerDown: function(eD) {
                    ...
                    eJ(undefined),
                    ej(undefined),
                    (null == eb ? undefined : eb.index) === ez.slotId ? r6.A.emit(r7.r.bKo, true, ez.recipeType) : eO({
                        index: ez.slotId,
                        count: ez.count,
                        total: ez.count,
                    ...
                    r6.A.emit(r7.r.bKo, false, ez.recipeType));
                },
        ...
        var FY = r3.Ay.div(['display:flex;flex-direction:column;align-items:flex-start;min-height:576px;min-width:480px;'])
          ...
          , FJ = function(ez) {
            ...
            Fx.TG)(function(R8, R9) {
              ...
              , R0 = Object.keys(eu)
              , R1 = Math.max(1, Math.ceil(R0.length / 0x19));
            (0,
            r5.useEffect)(function() {
                eO(Math.min(ej, R1 - 1));
            }, [ev]);
            for (var R2 = 0x19 * ej; R2 < Math.min(0x19 * ej + 0x19, R0.length); R2++) {
                var R3 = R0[R2]
                  ...
                  , R6 = (0,
                Fa.O)(R4.result.type)
                  , R7 = R4.ingredientSets[0].map(function(R8) {
                    var R9 = (0,
                ...
                5 === eb.length && (eD.push((0,
                rH.jsx)(Fj, {
                    children: eb
                }, eD.length)),
                eb = []);
            }
            return eb.length > 0 && eD.push((0,
            rH.jsx)(Fj, {
                children: eb
            }, eD.length)),
            (0,
        ...
        const E8 = function() {
            ...
            r4.x)(function(R0) {
              ...
              , eb = eO[rl.A.bsg + rl.A.bsJ + 1].bIo
              , eD = eO[rl.A.bsg + rl.A.bsJ + 2].bIo
              , eu = eO[rl.A.bsg + rl.A.bsJ + 3].bIo;
            return (0,
            r5.useEffect)(function() {
                undefined !== ej.current && ej.current.bWH(eJ);
            }, [eJ]),
            (0,
            r5.useEffect)(function() {
                undefined !== ej.current && ej.current.bWR(ev);
            }, [ev]),
            (0,
            r5.useEffect)(function() {
                undefined !== ej.current && ej.current.bWn(eb);
            }, [eb]),
            (0,
            r5.useEffect)(function() {
                undefined !== ej.current && ej.current.bWt(eD);
            }, [eD]),
            (0,
            r5.useEffect)(function() {
                undefined !== ej.current && ej.current.bWA(eu);
            }, [eu]),
            (0,
            r5.useEffect)(function() {
                if (null !== ez.current) {
                    var R0 = ez.current;
                    undefined === eA.current && (eA.current = new E3.WebGLRenderer({
                        canvas: R0,
                        antialias: false,
                        powerPreference: 'high-performance',
                        alpha: true
                    })),
                    eA.current.setSize(R0.clientWidth, R0.clientHeight, false);
                    var R1 = 2.5 * (R0.clientWidth / R0.clientHeight)
                      , R2 = new E3.OrthographicCamera(R1 / -2,R1 / 2,1.25,-1.25,0.1,0x3e8)
                      , R3 = new E3.Scene()
                      , R4 = new E3.AmbientLight(0xffffff,1)
                      , R5 = new E3.HemisphereLight(0xffffff,0xffffff,0.3)
                      , R6 = new E3.DirectionalLight(0xffffff,2);
                    R6.position.set(1, 1, 1),
                    R3.add(R4),
                    R3.add(R5),
                    R3.add(R6);
                    var R7 = new E4.A(0,undefined);
                    R7.bWZ([{
                        bIo: E6.v.bAB,
                        bWz: true
                    }]),
                    ej.current = R7,
                    R7.bWN((0,
                    E5.VB)(0, -rl.A.bNI.bbB / 2 - 0.1, -2.2)),
                    R7.bWx((0,
                    rI.LX)(0, Math.PI)),
                    R7.bWH(eJ),
                    R7.bWR(ev),
                    ...
                    var R9 = function(RE) {
                        var Rp = R0.getBoundingClientRect()
                          , RS = (0,
                        rI.LX)(Rp.x + Rp.width / 2, Rp.y + Rp.height / 4)
        ...
        const Ep = function() {
            ...
            r4.x)(function(R3) {
                return R3.bDF;
            }), eA = rl.A.bsg + rl.A.bsJ, ej = ez[eA], eO = rl.A.bsg + rl.A.bsJ + 1, eJ = ez[eO], ev = rl.A.bsg + rl.A.bsJ + 2, eb = ez[ev], eD = rl.A.bsg + rl.A.bsJ + 3, eu = ez[eD], R0 = [], R1 = rl.A.bsg + rl.A.bsJ + 4; R1 < rl.A.bsg + rl.A.bsJ + 4 + rl.A.bsG; R1++) {
                var R2 = ez[R1];
                R0.push((0,
                rH.jsx)(rz, {
                    background_icon: E2,
        ...
        var ES = r3.Ay.div(['display:flex;align-items:center;margin-right:14px;width:24px;'])
          ...
          , EH = function() {
            for (var ez = (0,
            r5.useState)(0), eA = ez[0], ej = ez[1], eO = (0,
            r4.x)(function(R6) {
                return R6.bJT;
            }), eJ = (0,
            r4.x)(function(R6) {
            ...
            }), eD = Object.keys(eb), eu = Math.ceil(eD.length / 4), R0 = 4 * eA; R0 < Math.min(4 * eA + 4, eD.length); R0++) {
                var R1 = eD[R0]
                  , R2 = eb[R1]
                  , R3 = eO[R1]
                  , R4 = (0,
                Fa.O)(R2.result.type)
                  , R5 = R2.ingredientSets[0].map(function(R6) {
                    var R7 = (0,
        ...
        var EB = Object.defineProperty
          ...
          , El = undefined;
        function EC(ez) {
            return Object.keys(ez).sort().filter(eA => undefined !== ez[eA]).map(eA => {
        ...
        function EN(ez, eA, ej={}, eO=El) {
            if (undefined === window.IntersectionObserver && undefined !== eO) {
                const eu = ez.getBoundingClientRect();
                return eA(eO, {
                    isIntersecting: eO,
                    target: ez,
                    intersectionRatio: 'number' == typeof ej.threshold ? ej.threshold : 0,
                    time: 0,
                ...
                if (!R2) {
                    ...
                    const R5 = new IntersectionObserver(R6 => {
                        R6.forEach(R7 => {
                            ...
                            R0.trackVisibility && undefined === R7.isVisible && (R7.isVisible = R9),
                    ...
                    ,R0);
                    R4 = R5.thresholds || (Array.isArray(R0.threshold) ? R0.threshold : [R0.threshold || 0]),
                    R2 = {
                        id: R1,
                        observer: R5,
                        elements: R3
            ...
            ev.observe(ez),
            function() {
                eD.splice(eD.indexOf(eA), 1),
                0 === eD.length && (eb.delete(ez),
                ev.unobserve(ez)),
                0 === eb.size && (ev.disconnect(),
                EX.delete(eJ));
            }
            ;
        }
        ...
        var EZ = rl.A.btp.map(function(ez) {
          ...
          , EU = function(ez) {
            var eA = function({threshold: eJ, delay: ev, trackVisibility: eb, rootMargin: eD, root: eu, triggerOnce: R0, skip: R1, initialInView: R2, fallbackInView: R3, onChange: R4}={}) {
                ...
                const RE = null == (R5 = R9.entry) ? undefined : R5.target
                  , Rp = r5.useRef();
          ...
          , ET = function() {
            ...
            for (var ev = [], eb = [], eD = 0; eD < EZ.length; eD++) {
                var eu = EZ[eD];
                eu.bXc.toLowerCase().includes(ej.toLowerCase()) && (ev.push((0,
                rH.jsx)(rz, {
                    draggable: false,
                    type: eu.bIo,
                    tier: eu.bJw,
                ...
                5 === ev.length && (eb.push((0,
                rH.jsx)(EU, {
                    children: ev
                }, eb.length)),
                ev = []));
            }
            return ev.length > 0 && (eb.push((0,
            rH.jsx)(EU, {
                children: ev
            }, eb.length)),
            ev = []),
        ...
        var Ek = r3.Ay.div.attrs(function(ez) {
          ...
          , EW = r3.Ay.div.attrs(function(ez) {
            ...
            return {
                style: {
                    transform: eA ? 'translate(calc(' + 0x32 * eA.bbZ + '%\x20' + (eA.bbZ > 0 ? '+' : '-') + '\x2020px),\x20calc(' + 0x32 * eA.bbB + '%\x20' + (eA.bbB > 0 ? '+' : '-') + '\x2020px))' : undefined
                }
            };
        })(['position:fixed;']);
        const Ex = function(ez) {
            ...
            var eb = rR.A ? undefined : (0,
            rI.LX)(ej.bbZ > window.innerWidth / 3 * 2 ? -1 : 1, ej.bbB > window.innerHeight / 3 * 2 ? -1 : 1);
            return (0,
            rH.jsxs)(Ek, {
                $mousePosition: ej,
                $uiScale: eJ,
                ...
                }), !rR.A && (null == ev ? undefined : ev.bIo) === r8.S.bDI && (0,
                rH.jsxs)(rH.Fragment, {
                    children: [(0,
                    rH.jsx)(EW, {
                        $dir: eb,
                ...
                rH.jsxs)(pE, {
                    ...
                    rH.jsx)(pR, {
                        ...
                        rH.jsx)(p7, {
                            label: ej.buttonText,
                            onClick: function() {
                                0 === ej.inputs.length && r6.A.emit(r7.r.bJf, ej.action, new Map());
                            },
                            width: '100%',
                            height: '28px',
                            fontSize: '24px'
        ...
        function ph(ez) {
            ...
            r5.useState)(false)
              ...
              , R3 = R1[1]
              , R4 = function(R5) {
                eb.current && !eb.current.contains(R5.target) && R3(false);
            };
            return (0,
            r5.useEffect)(function() {
                ...
                rH.jsxs)(pX, {
                    ...
                    rH.jsxs)(pw, {
                        ...
                        rH.jsxs)(pl, {
                            ...
                            children: ['' !== eJ ? eJ : 'Select\x20Option', (0,
                            rH.jsx)('span', {
                                children: '▼'
                            })]
                        }), (0,
        ...
        const pq = function(ez) {
            ...
            r5.useState)(null)
              ...
              , R0 = eD[1]
              , R1 = (0,
            r5.useState)(new Map(null == eb ? undefined : eb.map(function(R7) {
                return [R7.inputId, ''];
            })))
              , R2 = R1[0]
              , R3 = R1[1];
            ...
            var R4 = function(R7, R8) {
              ...
              , R5 = null == eb ? undefined : eb.map(function(R7) {
                var R8, R9;
                return R7 instanceof pG.A ? (0,
                rH.jsx)(pV, {
                    inputId: R7.inputId,
                    title: R7.title,
                    value: null != (R8 = R2.get(R7.inputId)) ? R8 : '',
                    onInputChange: R4
                }, R7.inputId) : R7 instanceof pk.A ? (0,
                rH.jsx)(ph, {
                    inputId: R7.inputId,
                    title: R7.title,
                    options: R7.options,
                ...
                rH.jsxs)(pu, {
                    ...
                    rH.jsx)(pv, {
                        ...
                        setValue: function(ev) {
                            ...
                            pD.bK)();
                            var R1 = ev.split('\x0a');
                            R1.length > 4 && (R1.length = 4),
                            R1.some(function(R2) {
                                return R2.length > rl.A.bGI;
                            }) || (ej(R1.join('\x0a')),
                            r6.A.emit(r7.r.bGb, (0,
                            E5.VB)(0, 0, 0), [{
                                bIo: pb.i.bGF,
                                bWz: null != (eb = R1[0]) ? eb : ''
                            }, {
        ...
        const Sy = function() {
            ...
            r4.x)(function(RF) {
              ...
              , eO = null;
            ej === r9.K.bDm ? eO = (0,
            rH.jsx)(Fb, {}) : ej === r9.K.bDj ? eO = (0,
            rH.jsx)(FW, {}) : ej === r9.K.btQ ? eO = (0,
            rH.jsx)(Fo, {
            ...
            rH.jsx)(Ea, {}) : ej === r9.K.btK ? eO = (0,
            rH.jsx)(EI, {}) : ej === r9.K.btc ? eO = (0,
            rH.jsx)(Eg, {}) : ej === r9.K.btx ? eO = (0,
            rH.jsx)(pj, {}) : ej === r9.K.bDQ ? eO = (0,
            rH.jsx)(pO, {}) : ej === r9.K.btg && (eO = (0,
            rH.jsx)(S0, {}));
            var eJ = (0,
            r4.x)(function(RF) {
                return RF.bJc;
            ...
            r5.useEffect)(function() {
                if (rR.A && eD) {
                    ...
                    Fx.pg)(eD.recipeType)
                      ...
                      , Rp = (0,
                    Fa.O)(RF.result.type)
                      , RS = RF.ingredientSets[0].map(function(RR) {
                        var RH = (0,
            ...
            rH.jsxs)(S1, {
                ...
                onPointerDown: function(RF) {
                    RF.target === R5.current && (rR.A || (null == eJ ? undefined : eJ.bIo) !== r8.S.bDI && r6.A.emit(r7.r.bKi, -1, RF.button));
                },
                    ...
                    if (rR.A) {
                        ...
                        if (RE && RE instanceof HTMLDivElement) {
                            ...
                            if (RE.dataset.slotId && 'number' == typeof Rp) {
                                ...
                                RE === R5.current && (ev ? r6.A.emit(r7.r.bKr, ev.index, -1, ev.count) : r6.A.emit(r7.r.bKq, r9.K.bfC));
                            R3(undefined),
                            R2(undefined),
                            R4(undefined),
                            R0(undefined),
        ...
        var Sd = r2(0x13f8b)
          , SP = r3.Ay.div(['padding-left:30px;padding-right:20px;padding-top:5px;padding-bottom:5px;text-indent:-20px;text-shadow:2px\x202px\x200\x20#3b3b3b;overflow-wrap:break-word;background-color:rgba(0,0,0,0.3);line-height:1.2;margin:4px\x200\x200\x200;opacity:', ';', ''], function(ez) {
            ...
            return 0 === ez.$opacity ? 'transition:\x20opacity\x20250ms\x20linear;' : '';
        });
        ...
        const ST = function(ez) {
            var eA = ez.top
              , ej = ez.left
              , eO = ez.size
              , eJ = undefined === eO ? 0x12c : eO
              , ev = ez.stickSize
              , eb = undefined === ev ? 0x64 : ev
              , eD = ez.baseColor
              , eu = undefined === eD ? 'rgba(255,255,255,.2)' : eD
              , R0 = ez.stickColor
              , R1 = undefined === R0 ? 'white' : R0
              , R2 = ez.sticky
              , R3 = undefined !== R2 && R2
              , R4 = (0,
            r4.x)(function(RP) {
                ...
                rH.jsx)(So, {
                    ...
                    rH.jsx)(SU, {
                        ...
                        onPointerDown: function(RP) {
                            RP.preventDefault(),
                            RP.stopPropagation(),
                            R8 || R6.current && R5.current && (Rp(true),
                            R9(RP.pointerId));
                        },
                        onPointerMove: function(RP) {
                            RR(RP);
        ...
        const Sk = function(ez) {
            var eA, ej = ez.size, eO = ez.top, eJ = ez.bottom, ev = ez.left, eb = ez.right, eD = ez.imgSize, eu = undefined === eD ? 0.8 * ej : eD, R0 = ez.img, R1 = ez.color, R2 = undefined === R1 ? 'rgba(255,255,255,.2)' : R1, R3 = ez.selectColor, R4 = undefined === R3 ? 'rgba(248,\x20178,\x2032,\x200.4)' : R3, R5 = ez.onPointerDown, R6 = ez.onPointerMove, R7 = ez.onPointerUp, R8 = ez.onClick, R9 = ez.keepDown, RF = undefined !== R9 && R9, RE = ez.isDown, Rp = ez.text, RS = ez.textColor, RR = undefined === RS ? '#fff' : RS, RH = ez.textSize, Ry = undefined === RH ? 0x10 : RH, Rd = (0,
            r4.x)(function(Rw) {
                return Rw.bjb;
            }), RP = (0,
            r5.useRef)(null), RQ = ej / 2, RB = eO ? eO / Rd - RQ : undefined, RM = eJ ? eJ / Rd - RQ : undefined, RX = ev ? ev / Rd - RQ : undefined, Rm = eb ? eb / Rd - RQ : undefined;
            return (0,
            rH.jsxs)(SV, {
                ref: RP,
                $size: ej,
        ...
        const Sa = function() {
            ...
            r5.useRef)(false)
              , eb = (0,
            r5.useState)(undefined)
              , eD = eb[0]
              , eu = eb[1]
              , R0 = function(R2) {
                if (ez.current) {
                    var R3 = ez.current.getBoundingClientRect()
                      , R4 = (R2.clientX - R3.left) / R3.width * 2 - 1
                      , R5 = -(R2.clientY - R3.top) / R3.height * 2 + 1;
                    r6.A.emit(r7.r.bKp, (0,
                    rI.LX)(R4, R5));
                }
            }
              , R1 = function(R2) {
            ...
            rH.jsx)(SW, {
                ...
                onPointerDown: function(R2) {
                    undefined === eO.current && (eO.current = R2.pointerId,
                    R2.stopPropagation(),
                    R2.preventDefault(),
                    R1(R2),
                    R0(R2),
                    ...
                    ej.current = setTimeout(function() {
                        r6.A.emit(r7.r.buN, true),
                        ev.current = true;
                    }, 0x190));
                },
                onPointerMove: function(R2) {
                    if (eO.current === R2.pointerId && !(eJ.current && (0,
                    rI.UZ)((0,
                    rI.LX)(R2.clientX, R2.clientY), eJ.current) < rl.A.bJJ * rl.A.bJJ)) {
                        var R3 = (0,
                        rI.LX)(undefined === eD ? 0 : R2.clientX - (eD.bbZ + 0x50) * eA, undefined === eD ? 0 : R2.clientY - (eD.bbB + 0x50) * eA);
                        R2.stopPropagation(),
                        R2.preventDefault(),
                        R1(R2),
                        R0(R2),
                        clearTimeout(ej.current),
                        ej.current = undefined,
                ...
                onPointerUp: function(R2) {
                    ...
                    clearTimeout(ej.current),
                    ej.current = undefined,
                    eO.current = undefined,
                    ev.current && r6.A.emit(r7.r.buN, false));
                },
                onClick: function(R2) {
                    R2.stopPropagation(),
                    R2.preventDefault(),
                ...
                rH.jsxs)(SI, {
                    ...
                    rH.jsx)(Sk, {
                        ...
                        onPointerDown: function() {
                            r6.A.emit(r7.r.bun, SB.IS.JUMP, true);
                        },
                        onPointerUp: function() {
                            r6.A.emit(r7.r.bun, SB.IS.JUMP, false);
                        }
                    }, 'JumpBtn'), (0,
                    rH.jsx)(Sk, {
                        size: 0x7d,
        ...
        const Sz = function() {
            ...
            r5.useState)(null != (ez = null == eA ? undefined : eA.bJX) ? ez : 0), eO = ej[0], eJ = ej[1], ev = (0,
            r5.useState)(false), eb = ev[0], eD = ev[1];
            return (0,
            r5.useEffect)(function() {
                eO > 0 && setTimeout(function() {
                    eJ(eO - 1);
                }, 0x3e8);
            }, [eO]),
            (0,
            r5.useEffect)(function() {
                undefined !== (null == eA ? undefined : eA.bJX) && eJ(eA.bJX),
                eD(false);
            }, [null == eA ? undefined : eA.bJX]),
            undefined === eA ? null : (0,
            rH.jsxs)(Sc, {
                onClick: function() {
                    eO > 0 || eb || (r6.A.emit(r7.r.bGZ),
                    eD(true));
                },
                children: [(0,
                rH.jsx)(Sq, {
                ...
                rH.jsx)(SY, {
                    children: eO > 0 ? 'Respawning\x20in\x20' + eO + '\x20seconds...' : eb ? 'Respawning...' : 'Click\x20anywhere\x20to\x20respawn!'
                })]
            });
        };
        ...
        const e4 = function(ez) {
            var eA = (0,
            e1.qE)((rl.A.bGH - ez.ping) / rl.A.bGH * 0x64, 0, 0x64)
              , ej = rM(eA)
        ...
        const eF = function() {
            ...
            if (!ez)
                return null;
            for (var ej = Object.values(eA), eO = ej.length <= 0x28 ? 10 : 0xf, eJ = [], ev = [], eb = 0, eD = ej; eb < eD.length; eb++) {
                var eu = eD[eb];
                eJ.push((0,
                rH.jsxs)(e7, {
                    children: [(0,
                ...
                eJ.length >= eO && (ev.push((0,
                rH.jsx)(e9, {
                    children: eJ
                }, ev.length)),
                eJ = []);
            }
            return eJ.length > 0 && ev.push((0,
            rH.jsx)(e9, {
                children: eJ
            }, ev.length)),
            (0,
        ...
        const ek = function(ez) {
            ...
            return window.adSDKType === es.a.bfy ? null : eb ? (0,
            rH.jsx)(eG, {
                id: eA
            }) : null;
        };
