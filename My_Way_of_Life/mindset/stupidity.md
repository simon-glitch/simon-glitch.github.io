...
I hope that other writers and intellectuals will find this essay helpful. This essay (essentially) lists clarifications on the meaning of the various synonyms to "stupid".
...
### Unintelligent
Intelligence is remarkably (i.e. *canonically*) hard to measure. I will define intelligence in a generic manner, since it's often used in a generic manner.
* Intelligence is how well a person {performs a task} or {shows understanding of a subject}, based on their undistracted, **unhindered** mental state.
* By "unhindered", I mean their mental state when the number of obstacles and unnecessary inconveniences has been minimized in such a way that is maximizes the **apparent intelligence** of the inidivudal.
* By "apparent intelligence", I mean the measured value of the intelligence, according to whichever measuring system **you** choose to use.
* By "you", I mean an organized or sentient entity which is interested in measuring the intelligence of an individual.

The strategy to measure intelligence is:
* Find a task (or subject) that you think is relevant.
    * If it's a subject, replace the subject with the task of demonstrating understanding about the subject.
* Find your individual.
* Make sure your testing environment is fair:
    * Free of distractions.
    * Free of inconveniences that are not part of some challenge which is necessarily required for the task.
* Observe the individual as they perform the task.
    * Or observe the results of the task.
* Determine (or use) a measuring system (of your choice) to measure the intelligence of the individual according to the observations.
* Consider analyzing or reporting the measured values.
* Consider forming a hypothesis or theory about intelligence if the measured values give convincing evidence for it.

## Conclusion
I hope my words and ideas have been helpful for you. I don't know if my instructions on how to measure intelligence are helpful. I do know that I repeated {words, phrases and ideas} a few times. I hope my repition made my ideas and claims more clear to you.

Keep in mind, this essay is somewhat opinionated, and is based on anecdotal evidence.
* Reminder: "anecdotal evidence" is means evidence composed of my own experiences. This includes:
    * Direct (in-person) experience
    * My own vague memories of real studies and real experiments
    * Stories I've heard
    * Common knowledge
    * Patterns I've noticed in society
    * Patterns I've noticed in media (on the internet)
    * Concepts that I've considered for various reasons:
        * When thinking about the theme of a story
        * When thinking about hypothetical situations
        * When trying to solve problems
        * Or even when trying to solve puzzles
    * My own (personal) {understanding and interpretation} of **real** {stories and events}
    * My own (personal) {understanding and interpretation} of **fictional** {stories and events}
    * Old wisdoms (such poems and sayings)
    * Idioms
    * Other folklore
    * My own opinions about how the world should be
    * My own theories about why the world is the way it is

I hope you understand my point:
* My claims might make sense, and you might agree with them, but they can still be wrong. My goal in any essay I right is (of course) to make claims that are as close to the truth as possible, but I'm not perfect.
