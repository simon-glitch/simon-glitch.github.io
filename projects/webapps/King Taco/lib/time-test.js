...
const time = function time(f, f_name, tg, do_record){
    ...
    const finish_t = function finish_t(){
        ...
        resolve_f({str, f_name, adt, dt, t1, t2, frame_count, n_total, eps});
    };
...
const options = {
    one: function(){
        ...
        time(function(){
            ...
            console.log(res.str);
            console.log(to_engineering(window.ccc) + " characters done!");
            console.log("speed: " + to_engineering(window.ccc / res.adt) + " chars/sec!");
        });
    },
    three: function(){
        // 3 string test
